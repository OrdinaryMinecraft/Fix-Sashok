...
public class BaseUtils
{
	...
	public static File getHomeDir()
	{
		...
		if(getPropertyString("mcdir") == null) {
			switch(getPlatform())
			{
				case 1: return new File(System.getProperty("user.home", "") );
				case 2:
		...
		{
			return new File(getPropertyString("mcdir") + path);
		}
	}	
	...
	{
		File dir1 = new File(BaseUtils.getAssetsDir().toString());
		if(!dir1.exists()) dir1.mkdirs();
		File dir2 = new File(BaseUtils.getConfigDir().toString());
    ...
    {
    	String[] options = { "Обычный","Шейдеры","Минимальный"};
    	return options;
    }
