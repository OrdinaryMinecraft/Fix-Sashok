...
public class Frame extends JFrame implements ActionListener, FocusListener
{
	...
	public Combobox server_options = new Combobox(getServerOptions(), 0);
	...
	public Textfield textdir = new Textfield();
	...
	public Button mc_directory = new Button(Message.mc_directory);
	...
	{			
		...
		server_options.addMouseListener(new MouseListener()
		{
			public void mouseReleased(MouseEvent e){}
			public void mousePressed(MouseEvent e) {}
			public void mouseExited(MouseEvent e)  {}
			...
			public void mouseClicked(MouseEvent e)
			{
				if(server_options.getPressed() || e.getButton() != MouseEvent.BUTTON1) return;

				setProperty("server_option", server_options.getSelectedIndex());
			}
		});

		mc_directory.addActionListener(this);
		...
		server_options.setSelectedIndex(getPropertyInt("server_option"));
	...
	public static void start()
	{
		...
		try
		{
			...
			try
			{
				...
				{
					main.textdir.setText(String.valueOf(getPropertyString("mcdir") + File.separator + Settings.baseconf + File.separator));
				}
				else 
				{
					main.textdir.setText(String.valueOf(getAssetsDir()));
				}
				...
				main.loadnews.setSelected(getPropertyBoolean("loadnews", false));
                //main.Music.setSelected(getPropertyBoolean("Music", false));
			} catch(Exception e){}
		} catch(Exception e)
		{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource() == mc_directory)
		{
	        ...
	        {
	        	setProperty("mcdir", fileChooser.getSelectedFile());
				main.textdir.setText(String.valueOf(getPropertyString("mcdir") + File.separator + Settings.baseconf + File.separator));
	        }
		}
